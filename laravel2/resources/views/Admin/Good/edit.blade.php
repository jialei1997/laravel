            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" action="/admin/good/{{ $ob->g_id }}" method='post' name='myform' enctype='multipart/form-data'>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           ...
                           <!--  <select class="small" title="" name="s_id">
                                @foreach($sort as $v)
                                    @if($v->s_upid == $v->s_id )
                                        <option value="{{$v->s_id}}" selected>{{$v->s_name}}</option>
                                    @endif
                                @endforeach
                            </select> -->
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name='g_name' value="{{ $ob->g_name }}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name='g_series' value="{{ $ob->g_series }}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name='g_price'  value="{{ $ob->g_price }}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name='g_title' value="{{ $ob->g_title }}" />
                        </div>
                    </div>     
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea name='g_info' cols='50' rows='7'style='resize:none'>{{ $ob->g_info }}</textarea>
                        </div>
                    </div>    
