        ...
        <div class="wrapper">
            <aside class="menu-bar">
                <ul class="portrait-box">
                    <li>
                        <a href="" title="编辑资料">
                        <img src="/Admin/uploads/{{ $data->u_pic }}" width="160">
                        </a>
                    </li>
                    <li class="mem-name member-menu-nickName"><i class="icon-mem"></i>{{ $data->u_name }}</li>
                ...
                <dl id="j_MyCenterMenus" class="menu">
                    ...
                    <dd class="menu-item on"><a href="/home/user">个人资料</a></dd>
            ...
            <article class="content">
                ...
                @endif
                    ...
                    <dd class="module-item">
                        <form class="information-form" action='/home/user' method='post' enctype='multipart/form-data'>
                        {{ csrf_field() }}
                        <table class="form-table">
                            ...
                            <tr>
                                <th>当前头像：</th>
                                <td>
                                    <img width='150px' src="/Admin/uploads/{{ $data->u_pic }}">
                                </td>
                            </tr>
                            <tr>
                                <th><span class="red">*</span>用户名：</th>
                                <td>
                                    <input class="user-name" name="u_name" type="text" value='{{ $data->u_name }}'>
                                </td>
                            </tr>
                            <tr>
                                <th><span class="red">*</span>更改头像：</th>
                                <td>
                                    <input type='file' name='u_pic'>
                                </td>
                            </tr>
                            <tr>
                                <th><span class="red">*</span>性别：</th>
                                <td class="sex-box">
                                    <input type="radio" name='u_sex' value="1" @if($data->u_sex == 1) checked @endif>男
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" name='u_sex' value="2" @if($data->u_sex == 2) checked @endif>女
                                </td>
                            </tr>
                            <tr>
                                <th><span class="red">*</span>年龄：</th>
                                <td>
                                    <input type='text' name='u_age' value='{{ $data->u_age }}'>
                                </td>
                            </tr>
                            <tr>
                                <th><span class="red">*</span>手机：</th>
                                <td>
                                    <input type='text' name='u_tel' value='{{ $data->u_tel }}'>
                                </td>
                            </tr>
                            <tr>
                                <th><span class="red">*</span>邮箱：</th>
                                <td>
                                    <input type='text' style="width:210px;" name='u_email' value='{{ $data->u_email }}'>
                                </td>
                            </tr>
